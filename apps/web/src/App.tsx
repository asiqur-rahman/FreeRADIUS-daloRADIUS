...
export function App() {
  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen bg-transparent px-4 text-slate-200">
        <div className="mx-auto flex min-h-screen max-w-md items-center justify-center">
          <div className="surface-dark-strong w-full rounded-[32px] px-6 py-10 text-center">
            ...
            <div className="mt-5 text-lg font-semibold tracking-tight text-white">
              Loading workspace
            </div>
